Hi, this application prints all numbers up to the number you have entered, whereby instead of printing out the number if it is divisible by 3, it will instead print out 'Fizz!'.
